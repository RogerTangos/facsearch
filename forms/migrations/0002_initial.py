...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forms_event', (
            ...
            ('lastEdit', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
    ...
    models = {
        ...
        u'forms.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastEdit': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
